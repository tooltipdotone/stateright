...
const LoginModal = ({
  ...
  useEffect(() => {
    if (isDemoMode && !IsRegisterModalOpen && IsLoginModalOpen) {
      setInputType("number");
      setInputValue("919876598765");
      setNumber("919876598765");
      setCountryCode("+91");
    }
  }, [isDemoMode, IsLoginModalOpen, IsRegisterModalOpen]);
  ...
  useEffect(() => {
    if (IsLoginModalOpen) {
      requestAnimationFrame(() => {
        ...
        // Focus the password input when the password screen is active
        else if (
          IsPasswordScreen &&
          !IsRegisterModalOpen &&
  ...
  }, [IsLoginModalOpen, IsPasswordScreen, IsRegisterModalOpen, IsOTPScreen]); // This will run whenever either IsLoginModalOpen or IsPasswordScreen changes
              ...
              <div >
                <div className="reg_modal_header">
                  ...
                  google_authentication === 1 ? (
                    ...
                    <>
                      <h2 className="reg_modal_title" style={{color: "#00175E",fontWeight : "bold"}}>
                        {IsRegisterModalOpen ? t("register") : t("login")}
                        {/* <span className="brand_name">
                          {" "}
                          {settings?.company_name}
                        </span> */}
                ...
                <div className="auth_modal_footer">
                  {t("agreeSignIn")} {settings?.company_name} {" "}
                  <Link
